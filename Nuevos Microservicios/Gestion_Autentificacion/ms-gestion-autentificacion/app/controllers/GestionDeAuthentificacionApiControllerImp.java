...
public class GestionDeAuthentificacionApiControllerImp implements GestionDeAuthentificacionApiControllerImpInterface {
    ...
    @Override
    public void logoutUser(@NotNull String tokenUse) throws Exception {
        UsuarioDB.deletUser(tokenUse);
    }

    @Override
    public Boolean token(@NotNull String authtokent) throws Exception {
        return new Boolean(UsuarioDB.isAuth(authtokent));
    }
