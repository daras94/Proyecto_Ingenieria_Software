...
public class GestionDeAlumnoApiController extends Controller {

    private final GestionDeAlumnoApiControllerImp imp;
    private final ObjectMapper mapper;

    @Inject
    private GestionDeAlumnoApiController(GestionDeAlumnoApiControllerImp imp) {
        this.imp = imp;
