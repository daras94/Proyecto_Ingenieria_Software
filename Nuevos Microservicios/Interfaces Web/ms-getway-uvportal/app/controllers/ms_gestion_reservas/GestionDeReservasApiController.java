...
public class GestionDeReservasApiController extends Controller {

    private final GestionDeReservasApiControllerImp imp;
    private final ObjectMapper mapper;

    @Inject
    private GestionDeReservasApiController(GestionDeReservasApiControllerImp imp) {
        this.imp = imp;
