...
@Configuration
@EnableSwagger2
@ComponentScan(basePackages = {"ms.profesor", "ms.profesor.controller", "ms.profesor.services"})
public class SwaggerDocumentationConfig {
    ...
    public Docket customImplementation() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("ms.profesor.controller"))
