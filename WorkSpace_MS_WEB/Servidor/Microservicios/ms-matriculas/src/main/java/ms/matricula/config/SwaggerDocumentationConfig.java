...
@Configuration
@EnableSwagger2
@ComponentScan(basePackages = { "ms.matricula", "ms.matricula.controller", "ms.matricula.services" })
public class SwaggerDocumentationConfig {
    ...
    public Docket customImplementation(){
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("ms.matricula.controller"))
