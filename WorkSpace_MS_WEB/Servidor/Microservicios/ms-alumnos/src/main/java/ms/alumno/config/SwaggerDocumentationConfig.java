...
@Configuration
@EnableSwagger2
@ComponentScan(basePackages = {"ms.alumno", "ms.alumno.controller", "ms.alumno.services"})
public class SwaggerDocumentationConfig {
    ...
    public Docket customImplementation() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("ms.alumno.controller"))
