            ...
            <div class="flex flex-4">
                <div class="box person">
                    <div class="image round">
                        <img src="${pageContext.request.contextPath}/res/images/pic03.jpg" alt="Person 1" />
                    </div>
                    <h3>Magna</h3>
                    <p>Cipdum dolor</p>
                </div>
                <div class="box person">
                    <div class="image round">
                        <img src="${pageContext.request.contextPath}/res/images/pic04.jpg" alt="Person 2" />
                    </div>
                    <h3>Ipsum</h3>
                    <p>Vestibulum comm</p>
                </div>
                <div class="box person">
                    <div class="image round">
                        <img src="${pageContext.request.contextPath}/res/images/pic05.jpg" alt="Person 3" />
                    </div>
                    <h3>Tempus</h3>
                    <p>Fusce pellentes</p>
                </div>
                <div class="box person">
                    <div class="image round">
                        <img src="${pageContext.request.contextPath}/res/images/pic06.jpg" alt="Person 4" />
                    </div>
                    <h3>Dolore</h3>
                    <p>Praesent placer</p>
                </div>
        ...
        <section id="three" class="wrapper special">
            <div class="inner">
                ...
                <div class="flex flex-2">
                    <article>
                        <div class="image fit">
                            <img src="${pageContext.request.contextPath}/res/images/pic01.jpg" alt="Pic 01" />
                        </div>
                        <header>
                    ...
                    <article>
                        <div class="image fit">
                            <img src="${pageContext.request.contextPath}/res/images/pic02.jpg" alt="Pic 02" />
                        </div>
                        <header>
