...
@Api(value = "espacio", description = "the espacio API")
public interface EspacioApi {

    @ApiOperation(value = "Dar de alta un espacio", notes = "", response = Void.class, tags={ "Espacio", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Void> espacioPost(@ApiParam(value = "Objeto JSON del contenido del espacio" ,required=true )  @Valid @RequestBody Espacio reserva);
